...
object YweetConverter {
  ...
  fun convertToBindingModel(
    yweetList: List<Yweet>,
  ): List<YweetBindingModel> =
    yweetList.map { yweet ->
      convertToBindingModel(yweet)
    }
  ...
  fun convertToBindingModel(
    ...
    YweetBindingModel(
      ...
      attachmentImageList =
        ImageConverter.convertToBindingModel(
          yweet.attachmentImageList,
        ),
    )
}
